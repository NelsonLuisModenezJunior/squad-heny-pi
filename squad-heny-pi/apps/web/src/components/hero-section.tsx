  ...
  return (
    <>
      <main className="relative overflow-hidden min-h-[90vh] h-[90vh] flex flex-col justify-center">
        ...
        {/* Animação de luz RGB */}
        <div className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-[#F3A302] via-[#FFB84D] to-[#FFD700] rounded-full blur-3xl opacity-0 animate-[pulse_4s_ease-in-out_infinite] -z-10" style={{ animationDelay: '0s' }} />
          ...
          <div className="mx-auto max-w-7xl px-6 w-full">
            <div className="text-center">
              ...
              <div className="mx-auto mb-8 flex w-fit">
                <Link
                  href="#link"
                  className="group bg-white/40 backdrop-blur-xl border border-white/60 hover:border-[#F3A302]/80 p-1 pl-4 pr-1 rounded-full shadow-lg hover:shadow-[0_0_30px_rgba(243,163,2,0.3)] transition-all duration-300"
                >
              ...
              {/* Título principal */}
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-white drop-shadow-lg mb-6">
                H[ENY]
              </h1>


              {/* Subtítulo */}
              <p className="mx-auto max-w-2xl text-lg md:text-xl text-white-700 drop-shadow-lg mb-12 leading-relaxed font-medium">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-center mb-12">
                <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-xl p-0.5 hover:border-[#F3A302]/80 transition-all hover:shadow-[0_0_20px_rgba(243,163,2,0.2)]">
                  <button className="px-8 py-3 bg-gradient-to-r from-[#F3A302] to-[#FFB84D] text-white font-bold rounded-[10px] hover:shadow-lg hover:shadow-[#F3A302]/50 transition-all">
                    Começar Análise
                  </button>
                </div>

                <button className="px-8 py-3 bg-white/40 backdrop-blur-xl border border-white/60 text-gray-800 font-bold rounded-xl hover:border-[#51A471]/80 hover:bg-white/50 transition-all duration-300">
                  Saiba Mais
                </button>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
                <div className="group bg-white/40 backdrop-blur-xl rounded-2xl p-6 border border-white/60 hover:border-[#F3A302]/80 transition-all hover:shadow-[0_0_20px_rgba(243,163,2,0.2)]">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Reduza suas contas de energia até 30% através de análises inteligentes e recomendações personalizadas
                  </p>
                </div>
                ...
                <div className="group bg-white/40 backdrop-blur-xl rounded-2xl p-6 border border-white/60 hover:border-[#51A471]/80 transition-all hover:shadow-[0_0_20px_rgba(81,164,113,0.2)]">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Contribua para um futuro mais verde monitorando seu impacto ambiental em tempo real
                  </p>
                </div>
                ...
                <div className="group bg-white/40 backdrop-blur-xl rounded-2xl p-6 border border-white/60 hover:border-[#79BA92]/80 transition-all hover:shadow-[0_0_20px_rgba(121,186,146,0.2)]">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Gerencie e monitore seu consumo de energia com relatórios detalhados e comparativos
                  </p>
                </div>
              </div>
            </div>
