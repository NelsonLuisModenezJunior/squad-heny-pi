    ...
    <div className="min-h-screen relative overflow-hidden text-gray-900 bg-gradient-to-br from-white via-white to-gray-50">
          ...
          >
            ...
            >
              <div className="inline-block bg-white/60 backdrop-blur-xl border border-white/80 rounded-full px-4 py-2 mb-6 shadow-lg">
                <span className="text-sm font-semibold text-[#51A471]">
                  O Desafio
                </span>
              </div>
            ...
            >
              A maioria dos brasileiros gasta 30% a mais com energia do que o
              necessário, sem nem perceber.
            </motion.p>
          </motion.div>
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-700">
            Três passos simples para revolucionar sua gestão energética
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              step: "01",
              title: "Configure Seu Local e Tarifa",
              description:
                "Informe seu estado, cidade e a tarifa de energia da sua região. O Heny calcula automaticamente seus gastos em tempo real.",
            ...
            },
            {
              ...
              description:
                "Adicione todos os eletrodomésticos da sua casa. Nossa base de dados contém centenas de modelos com dados reais de consumo.",
            ...
            },
            {
              ...
              description:
                "Obtenha relatórios inteligentes com filtros avançados que facilitam a visualização do consumo, permitindo comparar aparelhos e identificar padrões para otimizar sua economia de energia.",
            ...
            >
              <div className="bg-white/60 backdrop-blur-xl border border-white/80 rounded-2xl p-8 h-full hover:bg-white/70 transition-all duration-300 shadow-lg hover:shadow-xl">
                ...
                {idx < 2 && (
                  <div className="absolute -right-12 top-1/2 w-12 h-1 bg-gradient-to-r from-[#F3A302] to-[#79BA92] hidden md:block" />
                )}
              </div>
            </motion.div>
          ))}
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-700">
            Recursos desenvolvidos para maximizar sua economia e
            sustentabilidade
          </p>
        </motion.div>
          ...
          <div className="space-y-6">
            {activeTab === 0 && (
              ...
              >
                {[
                  {
                    title: "Redução de Até 30%",
                    desc: "Economize significativamente nas suas contas de energia",
                  },
                  {
                    title: "Análises Comparativas",
                    desc: "Compare o consumo real e custo de cada aparelho",
                  },
                  {
                    title: "Simulador Inteligente",
                    desc: "Projete economia ao trocar por equipamentos mais eficientes",
                  },
                  {
                    title: "Relatórios Mensais",
                    desc: "Acompanhe seu progresso e histórico de economia",
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
                    className="flex gap-4 items-start p-4 bg-white/40 backdrop-blur-xl border border-white/60 rounded-xl hover:bg-white/50 transition-all duration-300"
                  >
                ...
                {[
                  {
                    ...
                    desc: "Sistema fácil de usar, sem necessidade de conhecimento técnico",
                  },
                  {
                    title: "Sincronização Automática",
                    desc: "Seus dados sempre atualizados em tempo real",
                  },
                  {
                    title: "Acesso Multiplataforma",
                    desc: "Use no computador, tablet ou smartphone quando quiser",
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
        ...
        >
          ...
          <div className="relative bg-white/60 backdrop-blur-xl border border-white/80 rounded-3xl p-16 text-center shadow-xl">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Produzir mais com menos. Economize pela ecologia. Descubra quanto
              você pode economizar hoje mesmo.
            </p>
            <Link
              href="/relatorio"
              className="group/btn relative px-10 py-4 rounded-xl font-bold overflow-hidden text-lg inline-block"
            >
