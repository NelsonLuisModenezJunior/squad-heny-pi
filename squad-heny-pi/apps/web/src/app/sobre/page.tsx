    ...
    <div className="min-h-screen relative overflow-hidden text-gray-900">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none -z-10 opacity-30">
        <svg className="absolute w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 300 Q300 350 600 300 T1200 300" fill="none" stroke="#FFFFFF" strokeWidth="60" opacity="0.3" />
          <path d="M0 500 Q300 550 600 500 T1200 500" fill="none" stroke="#79BA92" strokeWidth="40" opacity="0.4" />
          <path d="M0 700 Q300 750 600 700 T1200 700" fill="none" stroke="#51A471" strokeWidth="30" opacity="0.4" />
        </svg>
      </div>
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {[ 
            { icon: Leaf, title: "Sustentável", text: "Comparação inteligente baseada em consumo e impacto." },
            { icon: Zap, title: "Eficiente", text: "Análise das tarifas locais para economia real." },
            { icon: Users, title: "Feito por Pessoas", text: "Um time dedicado a criar soluções de verdade." }
          ].map((item, i) => (
            <motion.div
              key={i}
        ...
        >
          ...
          <div className="space-y-6">
            <h2 className="text-4xl font-bold text-white drop-shadow-md">Quem Somos</h2>
            ...
            >
             Somos estudantes de Sistemas de Informação da FHO | UNIARARAS, atualmente no 4º semestre, desenvolvendo o Heny como parte do Projeto Interdisciplinar. Nosso objetivo é transformar conhecimento acadêmico em uma solução útil, moderna e alinhada às necessidades reais do consumidor.
            </motion.p>
            ...
            <motion.p
              ...
              className="bg-white/60 backdrop-blur-xl border border-white/40 p-5 rounded-2xl text-gray-800 leading-relaxed"
            >
             O Heny nasceu da união entre curiosidade tecnológica e interesse genuíno por sustentabilidade. Como entusiastas de inovação e desenvolvimento web, encontramos no projeto uma oportunidade de aplicar conceitos avançados enquanto contribuímos para um futuro mais consciente.
            </motion.p>
            ...
            <motion.p
              ...
              className="bg-white/60 backdrop-blur-xl border border-white/40 p-5 rounded-2xl text-gray-800 leading-relaxed"
            >
             Além de ser um trabalho acadêmico, o Heny representa nossa visão de como a tecnologia pode tornar escolhas sustentáveis mais acessíveis, intuitivas e impactantes. Para nós, este projeto é o início de uma jornada maior dentro da área de TI e da construção de soluções responsáveis.
            </motion.p>
          </div>
              ...
              >
                <div className="w-1/2">
                  <div className="bg-white/60 backdrop-blur-xl border border-white/40 p-6 rounded-2xl shadow-lg hover:shadow-xl hover:bg-white/70 transition">
                    <h3 className="text-2xl font-bold text-[#51A471]">{t.year}</h3>
                    <p className="font-semibold text-xl mt-1 text-gray-900">{t.title}</p>
          ...
          {teamMembers.map((member, idx) => (
            ...
            >
              <img
                ...
                className={`w-32 h-32 object-cover rounded-full mx-auto shadow-md border-4 border-[#79BA92] grayscale ${hoveredMember === idx ? 'grayscale-0' : ''} transition-all duration-500 hover:scale-110`}
              />

              <h3 className="text-2xl font-bold text-center mt-4 text-gray-900">{member.name}</h3>
              <p className={`text-center font-semibold transition-colors duration-300 ${hoveredMember === idx ? 'text-[#51A471]' : 'text-[#F3A302]'}`}>{member.role}</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {[ 
            { icon: Leaf, title: "Sustentabilidade", text: "Colocamos o meio ambiente no centro de todas as nossas decisões." },
            { icon: Zap, title: "Inovação", text: "Buscamos constantemente novas formas de resolver problemas ambientais." },
            { icon: Users, title: "Colaboração", text: "Acreditamos que juntos conseguimos gerar um impacto muito maior." }
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 40 }}
        ...
        >
          ...
          <div className="relative bg-white/60 backdrop-blur-xl border border-white/40 rounded-3xl p-12 text-center transform group-hover:scale-105 transition-transform duration-300 shadow-2xl">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Faça Parte da Missão</h2>
