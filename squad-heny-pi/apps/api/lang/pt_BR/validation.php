...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para modificar cada uma
    ...
    */
    ...
    'attributes' => [
        ...
        'comodo_id' => 'cômodo',
        'local_id' => 'local',
        'eletro_nome' => 'nome do eletrodoméstico',
        'eletro_potencia' => 'potência',
        'eletro_hrs_uso_dia' => 'horas de uso por dia',
        'eletro_mensal_kwh' => 'consumo mensal (kWh)',
        'eletro_anual_kwh' => 'consumo anual (kWh)',
        'eletro_custo_mensal' => 'custo mensal',
        'eletro_custo_anual' => 'custo anual',
        'eletro_emissao_co2_anual' => 'emissão de CO2 anual',
        'name' => 'nome',
        'email' => 'e-mail',
        'password' => 'senha',
